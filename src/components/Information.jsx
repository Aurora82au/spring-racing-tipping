        ...
        return (
            <div className="app">
                ...
                <p>
                    ...
                    <ul>
                        <li><span className="demo-square bg-blue"></span> Blue - Not Yet Run</li>
                        <li><span className="demo-square bg-orange"></span> Orange - About To Jump</li>
                        <li><span className="demo-square bg-red"></span> Red - Racing</li>
                        <li><span className="demo-square bg-green"></span> Green - Has Run</li>
                    </ul>
                </p>
                ...
                <p>When you click the admin link it will take you to the Admin page.  Currently on the Admin page you can set the placings and the status for each race.  In v2.0 I'd like to add more functionality here, like the ability to add scratchings and the ability to disable people from getting points, etc.</p>
                ...
                <ul className="future-plans">
                    ...
                    <li>
                        Make a version of the same app, but introduce some game type elements.  So it would be more for fun than serious tipping.  Could also be modified to be for the greyhounds.
                        <br />
                        Ideas for the game elements are:
                        <ul>
                            <li>
                                <div>7 x Carrots (1 per meet probably)</div>
                                <div>Tag line: Makes a horse surge home at the finish.</div>
                                <div>Explaination: Earn points for one place higher than it actually finishes. Wasted if the horse comes in 1st, or 5th or below.</div>
                            </li>
                            <li>
                                <div>2 x Purple Carrots</div>
                                <div>Tag line: More nutritious than regular carrots.</div>
                                <div>Explaination: Earn points for two places higher. Wasted if the horse comes in 1st, or 6th or below. If it comes in 2nd then get the points for 1st, same as a regular carrot</div>
                            </li>
                            <li>
                                <div>1 x Juiced Syringe</div>
                                <div>Tag line: Turn your nags into the Lance Armstrong of horses.</div>
                                <div>Explaination: Get double points for a whole race meet.</div>
                            </li>
                            <li>
                                <div>1 x Poisioned Syringe</div>
                                <div>Tag line: 'Phar Lap' a horse.</div>
                                <div>Explaination: Kill a horse so nobody can get points for it for that race. Perhaps could be a bonus that is awarded to the person who wins the second meet or something, so then it is limited to only being used once by one person, but affects everyone equally?</div>
                            </li>
                            <li>
                                <div>1 x Shank</div>
                                <div>Tag line: 'Monica Seles' a jockey.</div>
                                <div>Explaination: Shank a jockey so nobody can get points for them for that race meet. Perhaps could be a bonus that is awarded to the person that wins the first meet or something, so then it is limited to only being used once by one person, but affects everyone equally?</div>
                            </li>
                            <li>
                                <div>7 x Glue Sticks (1 per meet probably)</div>
                                <div>Tag line: Get out of a sticky situation.</div>
                                <div>Explaination: If any of the horses you pick come last, send them to the glue factory to earn 1 point.</div>
                            </li>
                            <li>
                                <div>1 x Ricky Bobby</div>
                                <div>Tag line: If you ain't first, your last.</div>
                                <div>Explaination: Pick a horse to put everything on (only one tip for that race).  If it comes first you get double points (6).  If it comes anything else you get nothing.</div>
                            </li>
                            <li>
                                <div>? x Michelle Payne</div>
                                <div>Tag line: She's bloody brillant.</div>
                                <div>Explaination: Something to do with being a woman?  Put Michelle Payne on your horse, and her time of the month attracts a bear, causing the horse to run faster? :D</div>
                            </li>
                            <li>
                                <div>? x Sugar Cubes</div>
                                <div>Tag line: ?</div>
                                <div>Explaination: Something good?</div>
                            </li>
                            <li>
                                <div>? x Riding Crops</div>
                                <div>Tag line: ?</div>
                                <div>Explaination: Something good or bad?</div>
                            </li>
                        </ul>
                    </li>
                </ul>
                <p>If you have any ideas for things to add or improve, let me know - sanmerah@gmail.com</p>
