...
export default class ResultsRace extends Component {
    ...
    render() {
        ...
        const tips = self.props.tips.map(punterTips => {
            return <Tip key={punterTips._id} tips={punterTips} meets={self.props.meets} selectedMeetId={this.props.selectedMeetId} punters={self.props.punters} user={self.props.user} placings={self.props.race.placings} />;
        });
        let statusClass;
        let statusName;
