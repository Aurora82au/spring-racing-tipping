...
export default class Results extends Component {
    ...
    render() {
        ...
        return (
            <div className="app">
                <Header page="Results" punters={this.props.punters} user={this.props.user} isAdmin={this.props.isAdmin} text="This is where you can see the results of the hours of peoples research, strategy and rumination....before they just picked a number because they liked the jockey's pink star-spangled uniform." />
