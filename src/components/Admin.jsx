...
export default class Admin extends Component {
    ...
    render() {
        ...
        return (
            <div className="app">
                <Header page="Administration" punters={this.props.punters} user={this.props.user} isAdmin={this.props.isAdmin} text="This is the Administration page used to set placings and race statuses.  In the future you will also be able to set scratchings." />
